...
class User1Content extends Component {
    constructor(props) {
        super(props)
    ...
    render() {
        ...
        return(
            <View style={{width:WIDTH, height: responsiveHeight(8),alignItems:'flex-start'}}>
                <View style={{backgroundColor:'white', marginBottom:moderateScale(5),flexDirection:'row' ,width: responsiveWidth(60), height: responsiveHeight(8), marginLeft: moderateScale(0)}}>
...
export default connect(mapStateToProps, mapDispatchToProps)(User1Content)
